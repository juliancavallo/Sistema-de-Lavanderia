...
namespace Controlador.Procesos
{
    public class ControladorEnvioALavadero
    {
        ...
        private void CargarCombos()
        {
            ...
            comboUbicacionOrigen.DataSource = ubicacionBLL.ObtenerTodos(SeguridadBLL.usuarioLogueado.Ubicacion.Id).Where(x => x.TipoDeUbicacion == (int)TipoDeUbicacion.Clinica && !x.EsUbicacionInterna).ToList();
            comboUbicacionOrigen.ValueMember = "Id";
            comboUbicacionOrigen.DisplayMember = "Descripcion";

            comboUbicacionDestino.DataSource = null;
            comboUbicacionDestino.DataSource = ubicacionBLL.ObtenerTodos().Where(x => x.TipoDeUbicacion == (int)TipoDeUbicacion.Lavanderia && !x.EsUbicacionInterna).ToList();
