...
{
    public class ControladorReporteEnviosInternos
    {
        ...
        #region Formulario
        public ControladorReporteEnviosInternos(Form frm, Form frmDetalle)
        {
            form = frm;
        ...
        private void FormLoad(object sender, EventArgs e)
        {
            ...
            CargarGrilla(envioBLL.ObtenerTodosParaVista(ubicacionesPorDefecto.Select(x => x.Id).ToList(),
                ...
                tipo: (int)Entidades.Enums.TipoDeEnvio.Interno));
        }
        #endregion
            ...
            try
            {
                if (DatosValidos())
                {
                    ...
                    CargarGrilla(envioBLL.ObtenerTodosParaVista(ubicacionesPorDefecto.Select(x => x.Id).ToList(),
                        ...
                        fechaDesde, fechaHasta, result, int.Parse(idEstado), (int)Entidades.Enums.TipoDeEnvio.Interno));
                }
            }
            catch (Exception ex)
            {
        ...
        private void CargarCombos()
        {
            ...
            var ubicacionesOrigen = ubicacionBLL.ObtenerPadreOHermanos(SeguridadBLL.usuarioLogueado.Ubicacion);
            ubicacionesOrigen.Add(SeguridadBLL.usuarioLogueado.Ubicacion);
            ...
            var ubicacionesDestino = ubicacionBLL.ObtenerPadreOHermanos(SeguridadBLL.usuarioLogueado.Ubicacion);
        ...
        private void ActualizarDestinos()
        {
            ...
            var ubicacionesDestino = ubicacionBLL.ObtenerPadreOHermanos(ubicacionOrigen);
