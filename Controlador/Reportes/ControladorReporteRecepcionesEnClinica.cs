...
{
    public class ControladorReporteRecepcionesEnClinica
    {
        ...
        #region Formulario
        public ControladorReporteRecepcionesEnClinica(Form frm, Form frmDetalle)
        {
            form = frm;
        ...
        private void FormLoad(object sender, EventArgs e)
        {
            ...
            CargarGrilla(recepcionBLL.ObtenerTodosParaVista(ubicacionesPorDefecto.Select(x => x.Id).ToList(),
                ...
                tipo: (int)Entidades.Enums.TipoDeUbicacion.Clinica));
        }
        #endregion
            ...
            try
            {
                if (DatosValidos())
                {
                    ...
                    CargarGrilla(recepcionBLL.ObtenerTodosParaVista(ubicacionesPorDefecto.Select(x => x.Id).ToList(),
                        ...
                        (int)Entidades.Enums.TipoDeUbicacion.Clinica));
                }
            }
            catch (Exception ex)
            {
