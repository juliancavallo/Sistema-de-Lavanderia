...
{
    public class ControladorReporteEnviosALavadero
    {
        ...
        #region Formulario
        public ControladorReporteEnviosALavadero(Form frm, Form frmDetalle)
        {
            form = frm;
        ...
        private void FormLoad(object sender, EventArgs e)
        {
            ...
            CargarGrilla(envioBLL.ObtenerTodosParaVista(ubicacionesPorDefecto.Select(x => x.Id).ToList(),
                ...
                tipo: (int)Entidades.Enums.TipoDeEnvio.ALavadero));
        }
        #endregion
            ...
            try
            {
                if (DatosValidos())
                {
                    ...
                    CargarGrilla(envioBLL.ObtenerTodosParaVista(ubicacionesPorDefecto.Select(x => x.Id).ToList(),
                        ...
                        fechaDesde, fechaHasta, result, int.Parse(idEstado), (int)Entidades.Enums.TipoDeEnvio.ALavadero));
                }
            }
            catch (Exception ex)
            {
        ...
        private void CargarCombos()
        {
            ...
            var ubicacionesOrigen = ubicacionBLL.ObtenerTodos(SeguridadBLL.usuarioLogueado.Ubicacion.Id).Where(x => !x.EsUbicacionInterna && x.TipoDeUbicacion.Id == (int)Entidades.Enums.TipoDeUbicacion.Clinica).ToList();
            ...
            var ubicacionesDestino = ubicacionBLL.ObtenerTodos().Where(x => !x.EsUbicacionInterna && x.TipoDeUbicacion.Id == (int)Entidades.Enums.TipoDeUbicacion.Lavanderia).ToList();
