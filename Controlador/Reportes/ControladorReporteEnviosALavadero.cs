...
namespace Controlador
{
    public class ControladorReporteEnviosALavadero
    {
        ...
        private void CargarCombos()
        {
            ...
            var ubicacionesOrigen = ubicacionBLL.ObtenerTodos(SeguridadBLL.usuarioLogueado.Ubicacion.Id).Where(x => !x.EsUbicacionInterna && x.TipoDeUbicacion == (int)Entidades.Enums.TipoDeUbicacion.Clinica).ToList();
            ...
            var ubicacionesDestino = ubicacionBLL.ObtenerTodos().Where(x => !x.EsUbicacionInterna && x.TipoDeUbicacion == (int)Entidades.Enums.TipoDeUbicacion.Lavanderia).ToList();
