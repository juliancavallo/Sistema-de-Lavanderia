...
namespace Controlador
{
    public class ControladorReporteRecepcionesEnLavadero
    {
        ...
        private void CargarCombos()
        {
            ...
            var ubicacionesOrigen = ubicacionBLL.ObtenerTodos().Where(x => !x.EsUbicacionInterna && x.TipoDeUbicacion == (int)Entidades.Enums.TipoDeUbicacion.Clinica).ToList();
            ...
            var ubicacionesDestino = ubicacionBLL.ObtenerTodos(SeguridadBLL.usuarioLogueado.Ubicacion.Id).Where(x => !x.EsUbicacionInterna && x.TipoDeUbicacion == (int)Entidades.Enums.TipoDeUbicacion.Lavanderia).ToList();
